...
class Visualizer:
    ...
    def __init__(
        ...
        for png in self.files:
            ...
            im_12 = Image.blend(im_1, im_2, 0.4)

            back = Image.new("RGBA", (im_1.width, im_1.height), color="black")
            front = Image.new("RGBA", (im_1.width, im_1.height), color="green")
...
def main(args: Namespace) -> None:
    ...
    if args.mode == "train":
        ...
        prediction_dir = train_dir / "train_outputs"
    else:
